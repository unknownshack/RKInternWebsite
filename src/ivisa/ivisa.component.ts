...
export class IvisaComponent implements OnInit {
...
{ label: 'Zimbabwe - ZW', value: 'ZW' }
  ...
  travelToCountries: { label: string, value: string }[] = [
    { label: 'Australia - AU', value: 'AU' },
{ label: 'Canada - CA', value: 'CA' },
{ label: 'France - FR', value: 'FR' },
{ label: 'Germany - DE', value: 'DE' },
...
{ label: 'Zimbabwe - ZW', value: 'ZW' }
  ...
  filteredTravelCountries: { label: string, value: string }[] = this.travelToCountries; // Initialize with all countries
